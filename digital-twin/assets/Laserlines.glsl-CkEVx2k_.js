import{zk as xe,zl as we,x2 as d,yi as P,x1 as q,w_ as r,wX as ie,xF as F,l_ as De,xH as L,i3 as ne,dV as u,cN as se,bw as Ve,x6 as ae,_ as re,x9 as le,xa as oe,xb as ce,x7 as he,uv as R,xi as de,yp as Ee,bk as c,hj as ye,c$ as I,lP as Le,xR as Ce,rH as Se,uk as Ae,ul as Me,c8 as ue,e as g,x8 as D,yy as Re,dw as $e,ee as H,za as Te,y0 as S,c_ as $,ds as G,e6 as pe,c9 as m,dt as b,zm as fe,hG as Oe,dX as ze,cZ as qe,dC as ge,dy as Ie,r5 as je,iG as Ne,xL as He,xB as We,bn as k,dH as N,y as A,a as Ue,dG as Be,xN as Fe,kH as X,zn as Ge,zo as T,zp as ke,t as Z,mw as Xe,kP as Ze,dR as Je,vS as Ke,dS as Qe,dT as Ye,dU as et,zq as tt,bp as J}from"./index-Bi7V-lOi.js";import{t as it}from"./LineVisualElement-B7ItPBB1.js";function _e(e,t){const n=e.fragment;n.include(xe),e.include(we),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new P("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new P("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new q("depthMap",(i,s)=>{var a;return(a=s.depth)==null?void 0:a.attachment}),new q("normalMap",i=>i.normals),new q("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
