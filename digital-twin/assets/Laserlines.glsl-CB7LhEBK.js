import{zS as we,zT as xe,x_ as d,y9 as P,yz as q,x$ as r,y0 as ie,yW as F,nO as De,yY as L,iE as ne,bq as u,ar as se,bM as Ee,yd as ae,bY as re,yf as le,yg as oe,yh as ce,yA as he,wb as R,yo as de,yv as Ve,as as c,iU as ye,aE as I,nE as Le,z6 as Ce,tL as Se,w0 as Ae,w1 as Me,aZ as ue,e as g,yc as D,zp as Re,aY as $e,eL as N,zU as Te,y6 as S,aL as $,aV as G,bF as pe,dl as m,aK as b,zV as fe,aN as Oe,bs as ze,aM as qe,aF as ge,a$ as Ie,tb as je,ki as We,yS as Ne,bc as X,bb as W,z0 as He,ba as Ue,y as A,a as Be,z2 as Fe,mt as Y,zW as Ge,zX as T,zY as Xe,bW as k,oj as Ye,lH as ke,bl as Ze,wN as Ke,bn as Je,bo as Qe,bp as et,zZ as tt,cF as Z}from"./index-DenhEmYc.js";import{t as it}from"./VisualElement-Vg1sQEhD.js";function _e(e,t){const n=e.fragment;n.include(we),e.include(xe),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new P("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new P("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new q("depthMap",(i,s)=>{var a;return(a=s.depth)==null?void 0:a.attachment}),new q("normalMap",i=>i.normals),new q("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
