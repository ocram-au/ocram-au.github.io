import{zT as we,zU as De,x$ as d,ya as P,yA as q,y0 as r,y1 as ie,yX as F,nP as xe,bJ as Ve,yZ as L,iJ as ne,aj as se,bq as u,ye as ae,yf as re,yg as le,yi as oe,yG as ce,wc as R,yp as he,bY as de,al as c,iZ as Ee,aG as I,nE as ye,z7 as Le,tL as Ce,yw as Se,w1 as Ae,w2 as Me,b0 as ue,zq as Re,e as g,yq as x,eL as N,a$ as $e,zV as Te,y7 as S,tb as Oe,d7 as m,aI as $,b3 as G,bF as pe,aF as b,zW as fe,b2 as ze,kn as qe,aL as Ie,bs as je,aJ as We,aH as ge,yT as Ne,ba as X,bi as W,z1 as He,z3 as Ue,mt as k,zX as Be,zY as T,zZ as Fe,bW as J,oj as Ge,lI as Xe,bk as ke,bl as Je,wO as Ze,bn as Ye,bo as Ke,bp as Qe,y as A,a as et,z_ as tt,cF as Z}from"./index-BR4NftXd.js";import{t as it}from"./VisualElement-DEpTAm69.js";function _e(e,t){const n=e.fragment;n.include(we),e.include(De),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new P("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new P("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new q("depthMap",(i,s)=>{var a;return(a=s.depth)==null?void 0:a.attachment}),new q("normalMap",i=>i.normals),new q("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
...
}`),t}const nt=se(),st=Ve(),at=Object.freeze(Object.defineProperty({__proto__:null,build:Pe},Symbol.toStringTag,{value:"Module"}));class O extends ae{initializeProgram(t){return new re(t.rctx,O.shader.get().build(this.configuration),me)}initializePipeline(){return le({blending:ce(R.ONE,R.ONE_MINUS_SRC_ALPHA),colorWrite:oe})}}O.shader=new he(at,()=>de(()=>Promise.resolve().then(()=>Pt),void 0));const me=new Map([[u.START,0],[u.END,1],[u.UP,2],[u.EXTRUDE,3]]);class Y{constructor(t){this._renderCoordsHelper=t,this._buffers=null,this._origin=c(),this._dirty=!1,this._count=0,this._vao=null}set vertices(t){const n=Ee(3*t.length);let i=0;for(const s of t)n[i++]=s[0],n[i++]=s[1],n[i++]=s[2];this.buffers=[n]}set buffers(t){if(this._buffers=t,this._buffers.length>0){const n=this._buffers[0],i=3*Math.floor(n.length/3/2);I(this._origin,n[i],n[i+1],n[i+2])}else I(this._origin,0,0,0);this._dirty=!0}get origin(){return this._origin}draw(t){const n=this._ensureVAO(t);n!=null&&(t.bindVAO(n),t.drawArrays(ye.TRIANGLES,0,this._count))}dispose(){this._vao!=null&&this._vao.dispose()}_ensureVAO(t){return this._buffers==null?null:(this._vao==null&&(this._vao=this._createVAO(t,this._buffers)),this._ensureVertexData(this._vao,this._buffers),this._vao)}_createVAO(t,n){const i=this._createDataBuffer(n);return this._dirty=!1,new Le(t,me,{data:Ce(ee)},{data:Ae.createVertex(t,Me.STATIC_DRAW,i)})}_ensureVertexData(t,n){var s;if(!this._dirty)return;const i=this._createDataBuffer(n);(s=t.vertexBuffers.data)==null||s.setData(i),this._dirty=!1}_createDataBuffer(t){const n=t.reduce((_,p)=>_+K(p),0);this._count=n;const i=ee.createBuffer(n),s=this._origin;let a=0,l=0;for(const _ of t){for(let p=0;p<_.length;p+=3){const C=I(Q,_[p],_[p+1],_[p+2]);p===0?l=this._renderCoordsHelper.getAltitude(C):this._renderCoordsHelper.setAltitude(C,l);const D=this._renderCoordsHelper.worldUpAtPosition(C,rt),o=a+2*p,B=ue(Q,C,s);if(p<_.length-3){i.up.setVec(o,D),i.up.setVec(o+3,D),i.up.setVec(o+5,D);for(let v=0;v<6;v++)i.start.setVec(o+v,B);i.extrude.setValues(o,0,-1),i.extrude.setValues(o+1,1,-1),i.extrude.setValues(o+2,1,1),i.extrude.setValues(o+3,0,-1),i.extrude.setValues(o+4,1,1),i.extrude.setValues(o+5,0,1)}if(p>0){i.up.setVec(o-2,D),i.up.setVec(o-4,D),i.up.setVec(o-5,D);for(let v=-6;v<0;v++)i.end.setVec(o+v,B)}}a+=K(_)}return i.buffer}}function K(e){return 3*(2*(e.length/3-1))}const rt=c(),Q=c(),ee=Se().vec3f(u.START).vec3f(u.END).vec3f(u.UP).vec2f(u.EXTRUDE);class H extends Re{constructor(){super(...arguments),this.contrastControlEnabled=!1}}g([x()],H.prototype,"contrastControlEnabled",void 0);const U=N(6);function be(e){const t=new ie;t.include(Te),t.include(_e,e);const n=t.fragment;if(e.lineVerticalPlaneEnabled||e.heightManifoldEnabled)if(n.uniforms.add(new d("maxPixelDistance",(i,s)=>e.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
