import{zT as we,zU as De,x$ as d,ya as P,yA as q,y0 as r,y1 as ie,yX as F,nO as xe,yZ as L,iE as ne,bq as u,ar as se,bM as Ee,ye as ae,bY as re,yg as le,yh as oe,yi as ce,yB as he,wc as R,yp as de,yw as Ve,as as c,iU as ye,aE as I,nE as Le,z7 as Ce,tL as Se,w1 as Ae,w2 as Me,aZ as ue,e as g,yd as x,zq as Re,aY as $e,eL as N,zV as Te,y7 as S,aL as $,aV as G,bF as pe,dl as m,aK as b,zW as fe,aN as Oe,bs as ze,aM as qe,aF as ge,a$ as Ie,tb as je,ki as We,yT as Ne,bc as X,bb as W,z1 as He,ba as Ue,y as A,a as Be,z3 as Fe,mt as k,zX as Ge,zY as T,zZ as Xe,bW as Y,oj as ke,lH as Ye,bl as Ze,wO as Ke,bn as Je,bo as Qe,bp as et,z_ as tt,cF as Z}from"./index-CnMvbdm6.js";import{t as it}from"./VisualElement-Bqidtlk9.js";function _e(e,t){const n=e.fragment;n.include(we),e.include(De),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new P("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new P("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new q("depthMap",(i,s)=>{var a;return(a=s.depth)==null?void 0:a.attachment}),new q("normalMap",i=>i.normals),new q("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
