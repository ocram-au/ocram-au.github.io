import{DP as Pe,DM as ve,Ei as be,BG as _,D0 as w,DR as De,BH as H,BE as r,cF as z,Bw as te,DO as Ee,CH as A,tM as we,hj as v,bv as ie,av as h,bw as R,ea as F,Ej as Ve,i_ as ne,C_ as se,Cg as T,eb as b,Ek as ae,aT as re,aU as le,e9 as xe,e7 as Se,kB as ye,jd as Le,en as Ce,bx as Ae,aw as oe,BI as ce,BJ as he,_ as de,Bv as Te,ck as G,ef as j,DN as Me,pJ as $e,f6 as Re,Ce as Ue,Da as Oe,aA as o,BD as k,aB as Ie,au as O,kJ as qe,ci as pe,aP as N,tE as je,fS as Ne,ts as ze,tt as Be,El as We,r as g,B_ as x,DV as He,DW as X,Em as Fe,En as Ge,q8 as ke,DX as c,Eo as U,Ep as Xe,DK as J,eh as Je,ei as Ze,rZ as Ke,ek as Ye,el as Qe,em as et,m as M,b as tt,Eq as it,f4 as Z}from"./index-BFA-xGSo.js";import{t as nt}from"./VisualElement-DMP0OeXj.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(ve),n.include(be),n.uniforms.add(new _("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new _("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new _("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new _("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>{var s;return(s=i.depth)==null?void 0:s.attachment}),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const B=z(6);function fe(t){const e=new te;e.include(Ee),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new _("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
